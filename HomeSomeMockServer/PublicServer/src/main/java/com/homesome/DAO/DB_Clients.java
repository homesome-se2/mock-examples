...
public class DB_Clients {
    ...
    public boolean hubLogin(int hubID, String password) throws Exception {
        //TODO: Implement hubLogin()
        // Does not return any data from DB. Valid login: Just return. Inavlid. Throw exception with custom msg for the client.
        return false;
    }
